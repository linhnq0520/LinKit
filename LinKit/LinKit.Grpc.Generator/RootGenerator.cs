        ...
        context.RegisterSourceOutput(
            ...
            (spc, services) =>
            {
                ...
                if (services.GrpcClientServices.Any())
                {
                    ...
                    spc.AddSource(
                        $"GrpcClient.DependencyInjection.g.cs",
                ...
                if (services.GrpcServices.Any())
                {
                    ...
                    spc.AddSource(
                        $"GrpcServer.DependencyInjection.g.cs",
                        SourceText.From(src, Encoding.UTF8)
                    );
                    ...
                    globalUsingsSource.AppendLine("// <auto-generated/> by LinKit.Grpc.Generator");
...
using LinKit.Core.Abstractions;"
    ...
    {"
        ...
        sb.AppendLine(
            $"            services.AddSingleton<IGrpcInterceptorProvider, DefaultGrpcInterceptorProvider>();"
        );
        sb.AppendLine(
            $"            services.AddSingleton<IMetadataProvider, DefaultMetadataProvider>();"
        );
        sb.AppendLine(
            $"            services.AddSingleton<IGrpcClientFactory, DefaultGrpcClientFactory>();"
        );
